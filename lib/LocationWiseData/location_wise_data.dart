...
class LocationWiseData extends StatefulWidget {
  const LocationWiseData({Key? key}) : super(key: key);

  @override
  _LocationWiseDataState createState() => _LocationWiseDataState();
}

class _LocationWiseDataState extends State<LocationWiseData> {
  @override
